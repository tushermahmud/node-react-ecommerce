...
const ProductCreateForm=({handleChange,handleSubmit,goBack,categories,values})=>{
    ...
    return (
        <form onSubmit={handleSubmit} className="mb-3">
            ...
            <div className="form-group">
                ...
                <input type="file" id="photo" name="photo" accept="image/*" onChange={handleChange}/>{values.name}
            </div>
            <div className="form-group">
